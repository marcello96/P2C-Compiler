...
public interface P2CVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link P2CParser#operators}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOperators(@NotNull P2CParser.OperatorsContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitRecordDefinition(@NotNull P2CParser.RecordDefinitionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link P2CParser#recordType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRecordType(@NotNull P2CParser.RecordTypeContext ctx);
	/**
